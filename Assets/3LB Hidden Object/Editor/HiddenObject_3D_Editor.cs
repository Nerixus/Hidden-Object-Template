...
{
    [CustomEditor(typeof(HiddenObject_3D)), CanEditMultipleObjects]
    public class HiddenObject_3D_Editor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            HiddenObject_3D myTarget = target as HiddenObject_3D;
