...
{
    [CustomEditor(typeof(HiddenObject_UI)), CanEditMultipleObjects]
    public class HiddenObject_UI_Editor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            HiddenObject_UI myTarget = target as HiddenObject_UI;
