...
namespace PixelCrushers.DialogueSystem.DialogueEditor
{
    ...
    public partial class DialogueEditorWindow
    {
        ...
        public void DrawAIBranchingConversationButton(Conversation conversation)
        {
            ...
            if (GUILayout.Button(new GUIContent("AI", "Dialogue Smith has discontinued their service, but we plan to implement branching dialogue natively in the future."), EditorStyles.miniButtonRight, GUILayout.Width(21)))
            {
